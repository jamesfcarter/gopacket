...
// (github.com/jamesfcarter/gopacket, github.com/jamesfcarter/gopacket/layers).
//
...
import (
	...
	"github.com/jamesfcarter/gopacket/layers"
	"log"
	"sync"
	"time"
)

var memLog = flag.Bool("assembly_memuse_log", false, "If true, the github.com/jamesfcarter/gopacket/tcpassembly library will log information regarding its memory use every once in a while.")
var debugLog = flag.Bool("assembly_debug_log", false, "If true, the github.com/jamesfcarter/gopacket/tcpassembly library will log verbose debugging information (at least one line per packet)")
